...
当前版本已经完成基础种菜闭环、简单任务系统，并加入第一版图鉴系统：
...
* 支持简单任务系统
* 支持第一次播种、第一次收获、累计收获 3 个星泡萝卜任务
* 任务完成后自动给予金币奖励
* 任务进度会保存到 JSON 存档
* 新增 `src/systems/codex_system.py` 图鉴系统
* 新增 `codex` 存档字段
* 播种星泡萝卜后，图鉴记录“已种植”
* 收获星泡萝卜后，图鉴记录“已收获”
* 按 `C` 可以打开或关闭游戏内简易图鉴面板
* 按 `Esc` 可以关闭图鉴面板
* 图鉴面板显示星泡萝卜中文名、英文名、描述、种植记录、收获记录和最佳种植方式状态
* 最佳种植方式当前固定显示“未解锁”
* 旧存档中已有作物时，图鉴会自动同步为“已种植”
