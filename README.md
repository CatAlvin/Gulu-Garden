...
当前版本已经完成基础种菜闭环、简单任务系统、图鉴基础版、多作物基础版、土地解锁基础版、背包界面基础版、正式商店面板基础版，并加入任务栏 UI 基础版：
...
| 按 `C`            | 打开或关闭图鉴面板               |
| 按 `Esc`          | 关闭当前打开的面板               |
| 按 `1`            | 商店关闭时：预览 Morning 昼夜阶段   |
| 按 `2`            | 商店关闭时：预览 Daytime 昼夜阶段   |
| 按 `3`            | 商店关闭时：预览 Evening 昼夜阶段   |
...
* 统一收获成功提示
* 统一离线成长提示
* 保留必要的英文术语，例如 Codex / Inventory / Shop
* 不新增玩法
* 不新增素材
* 不做复杂 UI 重构
