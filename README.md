...
当前版本已经完成基础种菜闭环、简单任务系统、图鉴基础版、多作物基础版、土地解锁基础版、背包界面基础版，并加入正式商店面板基础版：
...
* 商店面板显示三种种子商品
* 商店面板显示当前金币
* 商店面板显示商品名称、价格、拥有数量和购买状态
* 支持按 `1 / 2 / 3` 在商店面板中购买对应种子
* 支持鼠标点击商品行购买对应种子
* 商品行支持 hover 背景反馈
* 购买某种种子后会自动选中对应作物
* 商店面板中会用 `>` 标记当前选中作物
* 金币不足时，商店面板会显示金币不足状态
* 商店面板打开时，鼠标点击不会穿透到土地或后台按钮
* 商店、背包、图鉴面板互斥显示
* 按 `Esc` 可以关闭商店面板
