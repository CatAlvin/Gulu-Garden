...
当前版本已经完成基础种菜闭环、简单任务系统、图鉴基础版、多作物基础版、土地解锁基础版、背包界面基础版、正式商店面板基础版、任务栏 UI 基础版，并完成主要中文提示统一整理：
...
* 支持任务栏 UI 基础版
* 将主要操作反馈统一为中文
* 购买成功、金币不足、播种成功、收获成功等提示已中文化
* 图鉴更新提示已中文化
* 离线成长提示已中文化
* 昼夜预览提示已中文化
* HUD 昼夜阶段显示为中文 + 英文，例如 `白日 Daytime`
* 面板关闭提示已中文化
* locked 土地价格单位显示为 `金币`
* UI 标题保留中英双语风格
...
下一步建议为 Version 1.9 — UI 结构整理与小型重构。

Version 1.9 目标：

* 整理 `game.py` 中逐渐变长的 UI 绘制代码
* 视情况把通用面板绘制逻辑抽到 `src/ui/panel.py`
* 保留当前所有功能不变
* 不新增玩法
* 不新增素材
* 不重写主循环
